const translations = {
  ko: {
    ...
    "nav.experience": "경력",
    "nav.contact": "이야기 나누기",
    "hero.role": "AI 소프트웨어 엔지니어 · 서울",
    "hero.hello": "안녕하세요, 정서익입니다.",
    ...
    "work.note": "사내 기밀 없이 프로덕션 경험을 일반화해 소개합니다.",
  ...
  en: {
    ...
    "hero.role": "AI Software Engineer · Seoul",
    "hero.hello": "Hi, I’m Seoik.",
    ...
    "work.note": "Generalized from production experience without proprietary client details.",
